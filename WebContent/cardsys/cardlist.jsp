...
<body>
      ...
      <tr>
        ...
        <th width="10%">操作</th>
	       ...
	       <tr>
			...
			<td><fmt:formatDate pattern="yyyy-MM-dd HH:mm"  value="${cardinfo.addtime}" /></td> 
			<td>${cardinfo.state}</td> 
			<td>${cardinfo.remark}</td> 
        	<td>
			 <div class="button-group"> 
			 	<a class="button border-main" href="${pageContext.request.contextPath}/cardinfo/update.html?id=${cardinfo.id}"> 编辑</a> 
			 	<a class="button border-red" style="margin-left:5px;" href="${pageContext.request.contextPath}/cardinfo/delete.html?id=${cardinfo.id}" onClick="return del();">删除</a> 		
		     </div>
		    </td> 
		   </tr>
	    </c:forEach>
  ...
  <script type="text/javascript">
      ...
      var url = '${pageContext.request.contextPath}/cardinfo/list.html?';
