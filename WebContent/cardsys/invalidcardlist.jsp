...
<body>
  <div class="panel admin-panel">
    <h1 style="text-align:center">废卡列表</h1>
      ...
      <tr>
        ...
        <th width="20%">备注</th>
	       ...
	       <tr>
			...
			<td><fmt:formatDate pattern="yyyy-MM-dd HH:mm"  value="${cardinfo.invalidtime}" /></td> 
			<td>${cardinfo.state}</td> 
			<td>${cardinfo.invalidmsg}</td> 
		   </tr>
	    </c:forEach>
      	<tr>
        	<td colspan="9">
  ...
  <script type="text/javascript">
      ...
      var url = '${pageContext.request.contextPath}/cardinfo/invalidlist.html?';
