...
<body>
  <div class="panel admin-panel">
    <h1 style="text-align:center">老师列表</h1>
      ...
      <tr>
        ...
        <th width="10%">操作</th>
	       ...
	       <tr>
			...
			<td>${teacher.name}</td> 
			<td>${teacher.schooltime}</td> 
        	<td>
			 <div class="button-group"> 
			 	<a class="button border-main" href="${pageContext.request.contextPath}/teacher/update.html?id=${teacher.id}"> 编辑</a> 
			 	<a class="button border-red" style="margin-left:5px;" href="${pageContext.request.contextPath}/teacher/delete.html?id=${teacher.id}" onClick="return del();">删除</a> 		
		     </div>
		    </td> 
		   </tr>
	    </c:forEach>
  ...
  <script type="text/javascript">
      ...
      var url = '${pageContext.request.contextPath}/teacher/list.html?';
